...
export const events: EventItem[] = [
  {
    ...
    category: { tr: 'Sektör Buluşması', en: 'Industry Meetup' }, location: { tr: 'Konum güncellenecek', en: 'Location to be announced' }, image: '/images/events/coffeetalk.png', status: 'planned', isFeatured: true,
  },
  {
    ...
    category: { tr: 'Kariyer', en: 'Career' }, location: { tr: 'Konum güncellenecek', en: 'Location to be announced' }, image: '/images/events/muhnerde.png', status: 'planned', isFeatured: true,
  },
  {
    ...
    category: { tr: 'Savunma Sanayii', en: 'Defence Industry' }, location: { tr: 'Konum güncellenecek', en: 'Location to be announced' }, image: '/images/events/savunmagunlukleri.png', status: 'planned', isFeatured: true,
  },
  {
    ...
    category: { tr: 'Teknik Gezi', en: 'Technical Visit' }, location: { tr: 'Konum güncellenecek', en: 'Location to be announced' }, image: '/images/events/teknikgezi.png', status: 'planned', isFeatured: false,
  },
  {
    ...
    category: { tr: 'Eğitim', en: 'Training' }, location: { tr: 'Konum güncellenecek', en: 'Location to be announced' }, image: '/images/events/egitimler.png', status: 'planned', isFeatured: false,
  },
  {
    ...
    category: { tr: 'Sosyal', en: 'Social' }, location: { tr: 'Konum güncellenecek', en: 'Location to be announced' }, image: '/images/events/sosyaletkinlik.png', status: 'planned', isFeatured: false,
  },
];
